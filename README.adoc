...
This guide walks you through the process of creating a "App world" link:/understanding/REST[RESTful web service] with Spring.
...
`src/main/java/App/Greeting.java`
[source,java]
----
include::complete/src/main/java/App/Greeting.java[]
----
...
`src/main/java/App/GreetingController.java`
[source,java]
----
include::complete/src/main/java/App/GreetingController.java[]
----
...
[source,java]
----
include::complete/src/main/java/App/Application.java[]
----
